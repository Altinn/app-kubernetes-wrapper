...
expectedDeployment='[{"version":"1.23.2-alpine","release":"dummy-deployment","status":"Completed","availabilityPercentage":100},{"version":"local","release":"kuberneteswrapper","status":"Completed","availabilityPercentage":100}]'
