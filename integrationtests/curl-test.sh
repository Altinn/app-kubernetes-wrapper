...
expectedDeployment='[{"version":"1.23.2-alpine","release":"dummy-deployment","status":"Available","availabilityPercentage":100},{"version":"local","release":"kuberneteswrapper","status":"Available","availabilityPercentage":100}]'
